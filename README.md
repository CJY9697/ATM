...
3. **영수증 보기**:
   ...
   - 기록이 없을 경우, "영수증에 아무 내역도 없습니다." 메시지가 출력됩니다.
...
1. Python 3.9.6이 설치되어 있는지 확인합니다.
...
### 프로그램 실행
![Image](https://github.com/user-attachments/assets/f53d3ee1-2f69-45b5-9581-a4dae9cf2a3f)

---

## 🐛 에러 처리
- 입력 값이 숫자가 아니거나 음수일 경우, 경고 메시지가 출력됩니다.
- 잘못된 메뉴를 선택하면 ""제대로된 숫자형태로 입금액을 작성해주세요." 메시지가 출력됩니다.
